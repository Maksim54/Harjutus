...
namespace ConsoleApp1
{
    class Kutsekooliopilane : Isik
    {
        ...
        {
            Console.WriteLine($"Te töötab on {oppeasutus} eriala eest {eriala} on {kursus} ja toetus on {toetus} ja te tootasu on {arvutaSissetulek(palk, maksuvaba, tulumaks)}, te nimi on {nimi} {isikSugu} ja {arvutaVanus()}");
        }
    }
